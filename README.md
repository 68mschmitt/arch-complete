...
Primitive nodes include...
- Input (Single box with connection on right)
- Output (Single box with connection on left)
- Function Node (Single box with connection on left and right)
